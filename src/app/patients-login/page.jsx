            ...
            {activeTab === "login" && (
              ...
              >
                ...
                <div className="relative flex items-center py-2">
                  <div className="flex-grow border-t border-[#80A0B5]/20"></div>
                  <span className="flex-shrink-0 mx-4 text-[#80A0B5] text-sm">or</span>
                  <div className="flex-grow border-t border-[#80A0B5]/20"></div>
                </div>

                <Button
                  type="button"
                  onClick={() => signIn("google", { callbackUrl: "/patients-dashboard" })}
                  className="w-full h-11 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 text-base font-semibold rounded-xl shadow-sm hover:shadow-md transition-all duration-300 flex items-center justify-center gap-3 hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed"
                  disabled={isLoading}
                >
